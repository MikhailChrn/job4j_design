...
public class Shop extends AbstractStore {
    ...
    public boolean isValidToAdd(AbstractProduct product) {
        return super.getPercentOfFreshness(product) <= SHOP_BELOW
                && super.getPercentOfFreshness(product) >= TRASH_BELOW;
    }
    ...
    public void add(AbstractProduct product) {
        ...
        if (super.getPercentOfFreshness(product) <= DISCOUNT_BELOW) {
