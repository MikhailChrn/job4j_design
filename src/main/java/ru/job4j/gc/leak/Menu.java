...
/**
 * Реализация простая, но в коде есть места, в которых происходит утечка памяти,
 * а также присутствуют намеренные ошибки(чтобы закрепить уже пройденный по ходу курса материал),
 * которые приводят к созданию лишних объектов в хипе.
 *
 * Нужно поправить код, устранив факторы, которые могут привести к утечке памяти,
 * а также оптимизировать код в местах, где создаются лишние объекты в хипе.
 */
